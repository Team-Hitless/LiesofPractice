...
namespace LiesOfPractice.Utilities
{
    ...
    {
        public static int GetRelOffset(nint srcInstrAddr, nint targetAddr, int instrLength = 0)
            => (int)(targetAddr.ToInt64() - (srcInstrAddr.ToInt64() + instrLength));

        public static byte[] GetRelOffsetBytes(nint srcInstrAddr, nint targetAddr, int instrLength = 0)
        ...
        public static byte[] GetJmpOriginOffsetBytes(long hookLocation, int originalInstrLen, nint customCodeAddr)
        ...
        public static void WriteJumpOffsets(byte[] bytes,
            (long hookLocation, int originalInstrLen, nint customCodeAddr, int destinationIndex)[] jumpOffsets)
        {
