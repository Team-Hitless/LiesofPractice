...
public static class Patterns
{
    ...
    public static readonly Pattern GameMan = new(
        [0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x00, 0xC6, 0x80, 0x30],
        "xxx????xxx",
        0,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern SoloParamRepo = new(
        [0x89, 0x11, 0x33, 0xDB, 0x48, 0x89, 0x59, 0x08, 0x85, 0xD2],
        "xxxxxxxxxx",
        0x10,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern AiTargetingFlags = new(
        [0x81, 0xE2, 0xFF, 0x7F, 0xFD],
        "xxxxx",
        0x31,
        AddressingMode.Relative,
        2,
    ...
    public static readonly Pattern EventFlagMan = new(
        [0xBE, 0x02, 0x00, 0x00, 0x00, 0xE9, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8B, 0x0D],
        "xxxxxx????xxx",
        0xA,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern DebugFlags = new(
        [0x80, 0x3D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x74, 0x0A, 0xC7],
        "xx????xxxx",
        0,
        AddressingMode.Relative,
        2,
    ...
    public static readonly Pattern DebugEvent = new(
    ...
    public static readonly Pattern MapItemMan = new(
        [0x48, 0x8B, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8D, 0x94, 0x24, 0xC8],
        "xxx????xxxxx",
        0,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern GameDataMan = new(
        [0x05, 0x00, 0x00, 0x00, 0x00, 0x80, 0xB8, 0x82],
        "x????xxx",
        -0x2,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern DamageMan = new(
        [0x8B, 0x53, 0x2C, 0x48, 0x8B, 0x0D, 0x00, 0x00, 0x00, 0x00],
        "xxxxxx????",
        0x3,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern FieldArea = new(
        [0x48, 0x85, 0xC9, 0x74, 0x10, 0x48, 0x8B, 0x49],
        "xxxxxxxx",
        -0x7,
        AddressingMode.Relative,
        3,
    ...
    public static readonly Pattern SprjFlipper = new(
        [0x45, 0x89, 0x58, 0x5C],
        "xxxx",
        0x4,
        AddressingMode.Relative,
    ...
    public static readonly Pattern WorldObjManImpl = new(
        [0x48, 0x83, 0xEC, 0x20, 0x83, 0x3A, 0xFF, 0x48, 0x8B, 0xDA, 0x75, 0x28],
        "xxxxxxxxxxxx",
        0xE,
        AddressingMode.Relative,
        3,
